...
class Table extends Component {
    ...
    rent=(id)=>{
        console.log("asd");
        this.props.onRent(id);

    }
    returnBook = (id) =>{
        console.log("asd");
        this.props.onReturn(id);
    }
    ...
    editedOld = (event) =>{
        event.preventDefault()
        this.props.editBook(this.state.oldId,this.state.name,this.state.category,this.state.author,this.state.available)
        this.setState({
            oldId:0,
            isEditing:false,
            name:"",
      ...
      return  this.props.books.map((book)=>{
            ...
            return(
                <tr>
                    ...
                    <td><button class="btn btn-primary" onClick={()=>{this.returnBook(book.id)}}>Add a new book</button></td>
                </tr>
            )
